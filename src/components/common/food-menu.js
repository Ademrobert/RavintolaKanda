      ...
      <main className="max-w-6xl mx-auto">
        ...
        <section className="grid grid-cols-1 gap-6">
          ...
          <MenuSection
            title="Pizza"
            items={[
              { name: "Margherita", description: "Kirsikkatomaatti, rucola", prices: { Norm: 12.2, Perhe: 19.9 } },
              { name: "Bologna", description: "Paistettua jauhenlihaa", prices: { Norm: 12.2, Perhe: 19.9 } },
              { name: "Francescana", description: "Palvikinkku, katkarapu, herkkusieni", prices: { Medium: 14.9, Large: 23.4 } },
              { name: "Americano", description: "Palvikinkku, aurajuusto, ananas", prices: { Medium: 13.9, Large: 23.4 } },
              { name: "Special Opera", description: "Palvikinkku, katkarapu, herkkusieni", prices: { Medium: 13.9, Large: 23.4 } },
              { name: "Seafood", description: "Tonnikala, simpukka, katkarapu", prices: { Medium: 13.9, Large: 23.4 } },
              { name: "White Sabbath", description: "Smetana, juusto, permankinkku, rucola, herkkusieni", prices: { Medium: 13.9, Large: 23.4 } },
              { name: "Maruzella", description: "Mozzarelle, kirsikkatomaatti, rucola, pestokastike", prices: { Medium: 13.9, Large: 23.4 } },
              { name: "Vegetarian", description: "Herkkusieni, kirsikkatomaatti, paprika, punasipuli, oliivi", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "Antipasto", description: "Artisokka, aurinkokuivattu tomaatti, herkkusieni, punasipuli, rucola", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "Zucchini Rocks", description: "Kirsikkatomaatti, kesäkurpitsa, ricotta, punasipuli", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "Salmon", description: "Kylmäsavustettu lohi, punasipuli, aurinkokuivattu tomaatti, smetana, rucola", prices: { Medium: 15.9, Large: 26.8 } },
              { name: "Oma Valinta", description: "3/4 vapaavalintaista täytettä", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "Vegaani", description: "Tomaattikastike, vegaanijuusto, tu juusto, paprika, herkkusieni, kirsikkatomaatti, kapris", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "BBQ Chicken", description: "Grillattu kana, aurinkokuivattu tomaatti, punasipuli, BBQ-kastike", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "K&A Special", description: "Grillattu kana, ananas, rucola, parmesanjuutso", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "Smetana", description: "kebabliha, punasipuli, jalopeeno, kirsikkatomaatti, smetana", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "Super", description: "Salami, palvikinkku, pekoni, kananmuna", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "Romeo", description: "Salami, ananas, katkarapu, aurajuusto", prices: { Medium: 14.9, Large: 23.8 } },
              { name: "Dillinger", description: "Salami, palvikinkku, paistettu naudanliha, punasipuli", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "Empire Special", description: "Salami, katkarapu, palvikinkku, punasipuli, tuplajusto, valkosipuli", prices: { Medium: 14.9, Large: 23.8 } },
              { name: "Papa’s", description: "Salami, tuorepaprika, aurajuusto, punasipuli, oliivi", prices: { Medium: 14.9, Large: 23.8 } },
              { name: "Pepperoni", description: "Pepperoni, mozzarella, kirsikkatomaatti, pestokastike", prices: { Medium: 14.9, Large: 24.8 } },
              { name: "Mexicano", description: "Pepperoni, punasipuli, jalopeno, ananas, tulinen salsa", prices: { Medium: 15.9, Large: 26.4 } },
              { name: "Moussaka", description: "Munakoiso, fetajauhenliha, oliivi", prices: { Medium: 14.9, Large: 24.8 } },
            ]}
          />
